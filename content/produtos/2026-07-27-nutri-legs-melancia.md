...
categorias:
  - pre-treino
image: /imagens/uploads/NUTRILEGS.png
---
...
| Informação Nutricional | Quantidade por porção (20 g - 1 copo dosador cheio) | %VD* |
| -------------------------------------------------------------------------------- | --------------------------------------------------- | ---- |
| Valor energético (Kcal) | 60 | 3% |
| Carboidratos (g) | 13 | 4% |
| Açúcares totais (g) | 12 | 24% |
| Açúcares adicionados (g) | 12 | 24% |
| Gorduras totais (g) | 1 | 2% |
| Gorduras saturadas (g) | 0,8 | 4% |
| Vitamina D (mcg) | 25 | 100% |
...
| ** Não contém quantidade significativa de proteínas, fibras alimentares e sódio. |  |  |
